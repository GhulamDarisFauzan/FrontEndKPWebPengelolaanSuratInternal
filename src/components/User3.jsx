      ...
      <header className="bg-green-500 text-white">
        ...
        <div className="flex items-center justify-between px-6 py-3 bg-white">
          ...
          <nav className="flex items-center space-x-20">
            ...
            <a href="#" className="bg-green-500 px-4 py-1 rounded-full text-sm font-semibold text-white hover:bg-green-600">Surat M/K</a>
          ...
          <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
            ...
            <button onClick={() => navigate("/LSU1")} className="w-full">
              <div className="bg-gray-300 rounded shadow hover:shadow-lg transition">
                <img
                  src="./src/assets/Gambar Surat 2.png" // <- ganti nama file sesuai ilustrasi surat masuk
                  alt="Surat Masuk"
            ...
            <button onClick={() => navigate("/LSU2")} className="w-full">
              <div className="bg-gray-300 rounded shadow hover:shadow-lg transition">
                <img
                  src="./src/assets/Gambar Surat 3.png" // <- ganti nama file sesuai ilustrasi surat keluar
                  alt="Surat Keluar"
                  className="h-72 w-full object-contain rounded-t"
                />
                <div className="h-24 flex items-center justify-center rounded-b">
