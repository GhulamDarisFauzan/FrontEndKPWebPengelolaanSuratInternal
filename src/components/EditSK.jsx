      ...
      {menuOpen && (
        <div className="fixed top-0 right-0 w-64 h-full bg-white z-50 shadow-lg p-6">
          ...
          <ul className="space-y-4">
            <li>
              <a href="/DashboardAdmin1" className="text-black text-sm font-medium">
                Home
              </a>
            </li>
            <li>
              <a href="/DashboardAdmin2" className="text-black text-sm font-medium">
                Template Surat
              </a>
            </li>
            <li>
              <a
                href="#"
                className="block bg-green-500 text-white text-sm font-semibold px-4 py-1 rounded-full text-center"
              >
                Surat M/K
              </a>
            </li>
