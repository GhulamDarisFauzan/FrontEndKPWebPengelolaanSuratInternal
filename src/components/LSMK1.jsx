  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="px-8 py-10 text-center">
        <h2 className="font-bold text-lg mb-10">“Lihat Surat Masuk & Keluar”</h2>
          ...
          <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 px-6">
            ...
            <button onClick={() => navigate("/LSA1")} className="w-full">
              <div className="bg-gray-300 rounded shadow hover:shadow-lg transition">
                ...
                <div className="h-24 flex items-center justify-center rounded-b">
                  <p className="font-bold text-lg">Lihat Surat Masuk</p>
                </div>
              </div>
            </button>
            ...
            <button onClick={() => navigate("/LSA2")} className="w-full">
              <div className="bg-gray-300 rounded shadow hover:shadow-lg transition">
                ...
                />
                <div className="h-24 flex items-center justify-center rounded-b">
                  <p className="font-bold text-lg">Lihat Surat Keluar</p>
                </div>
              </div>
            </button>
          </div>
